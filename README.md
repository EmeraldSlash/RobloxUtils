...
Some of the code in this module is subject to the following trade-off: some reusable can noticeably simplify and reduce LOC in usage code, but the boilerplate of defining & importing that code can often negate any benefits one would get. Having all the reusable code be in a single module keeps that code net favourable. It's an economy of scale.
